...
const Pricing = () => {
  ...
  const fursatServiceFeePer =
    parseInt(process.env.NEXT_PUBLIC_FURSAT_SERVICE_FEE_PER || "5") / 100;
  ...
  const fursatFee = originalPriceInt * fursatServiceFeePer;

  const earnings = Math.max(
    propertyDetails.postedByOwner
      ? Math.max(
          originalPriceInt - b2bPriceInt > fursatFee
            ? b2bPriceInt
            : b2bPriceInt - fursatFee,
          b2bPriceInt - fursatFee
        )
      : originalPriceInt - b2bPriceInt - fursatFee,
    0
            ...
            <p>
              ...
              <HoverCard openDelay={100}>
                ...
                <HoverCardContent className="text-sm space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <p>Fursat service fee ({fursatServiceFeePer * 100}%)</p>
                    <p className="font-bold">
                      - ₹
                      {(
